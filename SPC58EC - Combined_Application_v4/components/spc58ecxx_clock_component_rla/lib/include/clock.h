...
/**
 * @file    clock.h
 * @brief   SPC58ECxx clock subsystem header
 *
 * @addtogroup CLOCK
 * @{
 */
 ...
 */
#define SPC5_PLL1_CLK_MAX                   200000000U
 ...
 */
#define SPC5_LIN_CLK1_MAX                   80000000U
 ...
 * @note    The default value is calculated for XOSC=40MHz and PLL0PHI=160MHz.
 */
 ...
 * @note    The default value is calculated for XOSC=40MHz and PLL0PHI1=60MHz.
 */
...
/* Check on the CORE0 divider settings.*/
#if (SPC5_CGM_CORE0_DC_DIV_VALUE >= 1U) && (SPC5_CGM_CORE0_DC_DIV_VALUE <= 2U)
#define SPC5_CGM_CORE0_DC_BITS              ((uint32_t)(0x8000U |           \
                                             (uint8_t)(SPC5_CGM_CORE0_DC_DIV_VALUE - 1U)) << 16)
#else
#error "invalid SPC5_CGM_CORE0_DC_DIV_VALUE value specified"
#endif
