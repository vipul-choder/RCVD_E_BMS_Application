...
/**
 * @file    clock.c
 * @brief   SPC58ECxx clock subsystem source.
 *
 * @addtogroup CLOCK
 * @{
 */
...
/**
 * @brief   SPC58ECxx clocks and PLL initialization.
 *
...
void spc_clock_init(void) {
  ...
  /* Setting the core0 divider to its final value.*/
#if (SPC5_CGM_CORE0_DC_DIV_VALUE == 2U)
  PCM_0.PCM1.B.ZXA_100MHZ_EN = 0;
  MC_CGM.CORE0_DC.R     = SPC5_CGM_CORE0_DC_BITS;
#endif /* SPC5_CGM_CORE0_DC_DIV_VALUE */
