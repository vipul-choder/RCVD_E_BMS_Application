...
struct MC_ME_tag {
    ...
    union {
        ...
        struct {
            ...
            vuint32_t unused_1:9;
            vuint32_t S_SAR_ADC_10BIT_STDBY_SEQ:1;
...
struct PCM_tag {
    ...
    union {
        ...
        struct {
            ...
            vuint32_t BWE_HSM:1;
            vuint32_t unused_1:2;
            vuint32_t EN_HSIZE_MUX_PBRIDGE:1;
            vuint32_t ZXA_100MHZ_EN:1;
            vuint32_t MSTR_STALL_NXMC_OVF_B:1;
            vuint32_t PRE_PBRIDGE2:1;
            vuint32_t BRE_PBRIDGE2:1;
            vuint32_t BWE_PBRIDGE2:1;
            vuint32_t PRE_PBRIDGE1:1;
            vuint32_t BRE_PBRIDGE1:1;
            vuint32_t BWE_PBRIDGE1:1;
...
#define SEMA4_0                               (*(volatile struct SEMA42_tag *) 0xf403c000UL)
...
#define STM_0                                    (*(volatile struct STM_tag *) 0xf4068000UL)
#define STM_2                                    (*(volatile struct STM_tag *) 0xf4070000UL)
#define SWT_0                                    (*(volatile struct SWT_tag *) 0xf4050000UL)
